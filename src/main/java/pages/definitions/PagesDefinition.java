...
public class PagesDefinition {
    ...
    public static final String AUTHENTIFICATION_PAGE = "https://auth.emag.ro/user/login";
    public static final String FACEBOOK_ACCOUNT_REDIRECT_PAGE = "https://www.facebook.com/";
    public static final String GOOGLE_ACCOUNT_REDIRECT_PAGE = "https://accounts.google.com/";
